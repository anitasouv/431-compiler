   ...
   public void typeOpCheck(List<TypeDeclaration> types, List<Declaration> decls, List<Function> func, Function curFunc) {  
     ...
     switch (operator){
        ...
        case EQ:
            ...
            r = right.getType(types, decls, func, curFunc).equals(new IntType());
		if (!l || !r) {
      	    		l = left.getType(types, decls, func, curFunc).equals(right.getType(types, decls, func, curFunc));
			r = l;
		}
            break;
      	case NE:
      ...
      if ((!l || !r) && !(left.getType(types, decls, func, curFunc) instanceof StructType && right.getType(types, decls, func, curFunc) instanceof NullType) ) {
