...
LU38:
	...
	%u103 = load i32* @_scanned_
	store i32 %u103, i32* %a
	call i32 (i8*, ... )*  @scanf(i8* getelementptr inbounds ([4 x i8]*@.read, i32 0, i32 0), i32* @_scanned_)
	%u104 = load i32* @_scanned_
	store i32 %u104, i32* %b
	call i32 (i8*, ... )*  @scanf(i8* getelementptr inbounds ([4 x i8]*@.read, i32 0, i32 0), i32* @_scanned_)
	%u105 = load i32* @_scanned_
	store i32 %u105, i32* %c
	call i32 (i8*, ... )*  @scanf(i8* getelementptr inbounds ([4 x i8]*@.read, i32 0, i32 0), i32* @_scanned_)
	%u106 = load i32* @_scanned_
	store i32 %u106, i32* %d
	call i32 (i8*, ... )*  @scanf(i8* getelementptr inbounds ([4 x i8]*@.read, i32 0, i32 0), i32* @_scanned_)
	%u107 = load i32* @_scanned_
	store i32 %u107, i32* %e
	%u108 = load i32* %a
	call void @tailrecursive(i32 %u108)
	%u110 = load i32* %a
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u110)
	%u111 = load i32* %b
	call void @domath(i32 %u111)
	%u113 = load i32* %b
	...
	%u117 = load i32* %d
	%u118 = load i32* %e
	%u119 = call i32 @ackermann(i32 %u117, i32 %u118)
