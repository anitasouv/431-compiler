...
LU81:
	...
	br i1 %u521, label %LU82, label %LU83
LU82:
	%u522 = load i32* %b
	%u523 = icmp eq i32 %u522, 2
	br i1 %u523, label %LU84, label %LU85
LU84:
	%u524 = load i32* %a
	%u525 = add i32 %u524, 1
...
LU110:
	...
	%u583 = load i32* @_scanned_
	store i32 %u583, i32* %input
	store i32 1, i32* %i
	br label %LU112
LU112:
	%u584 = load i32* %i
	...
	br i1 %u586, label %LU113, label %LU114
LU113:
	%u587 = call i32 @constantFolding()
	store i32 %u587, i32* %result
	%u589 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u589)
	%u590 = call i32 @constantPropagation()
	store i32 %u590, i32* %result
	%u592 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u592)
	%u593 = call i32 @deadCodeElimination()
	store i32 %u593, i32* %result
	%u595 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u595)
	%u596 = call i32 @interProceduralOptimization()
	store i32 %u596, i32* %result
	%u598 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u598)
	%u599 = call i32 @commonSubexpressionElimination()
	store i32 %u599, i32* %result
	%u601 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u601)
	%u602 = call i32 @hoisting()
	store i32 %u602, i32* %result
	%u604 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u604)
	%u605 = call i32 @doubleIf()
	store i32 %u605, i32* %result
	%u607 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u607)
	%u608 = call i32 @integerDivide()
	store i32 %u608, i32* %result
	%u610 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u610)
	%u611 = call i32 @association()
	store i32 %u611, i32* %result
	%u613 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u613)
	%u614 = load i32* %input
	%u615 = sdiv i32 %u614, 1000
	%u616 = call i32 @tailRecursion(i32 %u615)
	store i32 %u616, i32* %result
	%u618 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u618)
	%u619 = call i32 @unswitching()
	store i32 %u619, i32* %result
	%u621 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u621)
	%u622 = load i32* %input
	%u623 = call i32 @randomCalculation(i32 %u622)
	store i32 %u623, i32* %result
	%u625 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u625)
	%u626 = load i32* %input
	%u627 = sdiv i32 %u626, 5
	%u628 = call i32 @iterativeFibonacci(i32 %u627)
	store i32 %u628, i32* %result
	%u630 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u630)
	%u631 = load i32* %input
	%u632 = sdiv i32 %u631, 1000
	%u633 = call i32 @recursiveFibonacci(i32 %u632)
	store i32 %u633, i32* %result
	%u635 = load i32* %result
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u635)
	%u636 = load i32* %i
	%u637 = add i32 %u636, 1
	store i32 %u637, i32* %i
	br label %LU112
LU114:
