...
LU31:
	...
	store i32 %u42, i32* %number
	%u43 = load i32* %number
	%u44 = call i32 @convertToDecimal(i32 %u43)
	store i32 %u44, i32* %number
	%u46 = load i32* %number
	%u47 = load i32* %number
	%u48 = mul i32 %u46, %u47
	store i32 %u48, i32* %waitTime
	br label %LU33
LU33:
	%u49 = load i32* %waitTime
	%u50 = icmp sgt i32 %u49, 0
	br i1 %u50, label %LU34, label %LU35
LU34:
	%u51 = load i32* %waitTime
	%u52 = call i32 @wait(i32 %u51)
	%u54 = load i32* %waitTime
	%u55 = sub i32 %u54, 1
	store i32 %u55, i32* %waitTime
	br label %LU33
LU35:
	%u56 = load i32* %number
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u56)
	store i32 0, i32* %_retval_
	br label %LU32
LU32:
	%u57 = load i32* %_retval_
	ret i32 %u57
}
