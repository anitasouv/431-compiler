...
LU20:
	...
	%u27 = load i32* %num1
	%u28 = call i32 @fact(i32 %u27)
	store i32 %u28, i32* %num1
	%u30 = load i32* %num2
	%u31 = call i32 @fact(i32 %u30)
	store i32 %u31, i32* %num2
	%u33 = load i32* %num1
	%u34 = load i32* %num2
	%u35 = call i32 @sum(i32 %u33, i32 %u34)
	call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u35)
	call i32 (i8*, ... )*  @scanf(i8* getelementptr inbounds ([4 x i8]*@.read, i32 0, i32 0), i32* @_scanned_)
	%u37 = load i32* @_scanned_
	store i32 %u37, i32* %flag
	br label %LU19
LU21:
