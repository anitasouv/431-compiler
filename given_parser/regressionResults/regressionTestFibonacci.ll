...
LU12:
	...
	br label %LU13
LU13:
	%u13 = call i32 (i8*, ... )*  @scanf(i8* getelementptr inbounds ([4 x i8]*@.read, i32 0, i32 0), i32* @_scanned_)
	%u14 = load i32* @_scanned_
	store i32 %u14, i32* %input
	%u15 = load i32* %input
	%u16 = call i32 @computeFib(i32 %u15)
	%u18 = call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.println,i32 0, i32 0), i32 %u16)
	store i32 0, i32* %_retval_
	br label %LU14
LU14:
