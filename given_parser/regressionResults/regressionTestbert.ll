...
LU86:
	...
	br i1 %u174, label %LU87, label %LU88
LU87:
...
LU154:
	...
	store i32 %u436, i32* %element
	%u437 = load %struct.node** %myList
	%u438 = load i32* %element
	%u439 = call %struct.node* @add(%struct.node* %u437, i32 %u438)
	store %struct.node* %u439, %struct.node** %myList
	%u441 = load %struct.node** %myList
	%u442 = call %struct.node* @myCopy(%struct.node* %u441)
	store %struct.node* %u442, %struct.node** %copyList1
	%u444 = load %struct.node** %myList
	%u445 = call %struct.node* @myCopy(%struct.node* %u444)
	store %struct.node* %u445, %struct.node** %copyList2
	%u447 = load %struct.node** %copyList1
	%u448 = call %struct.node* @quickSortMain(%struct.node* %u447)
	store %struct.node* %u448, %struct.node** %sortedList
	%u450 = load %struct.node** %sortedList
	call void @freeList(%struct.node* %u450)
	%u452 = load %struct.node** %copyList2
	call void @treeMain(%struct.node* %u452)
	%u454 = load i32* %i
	%u455 = add i32 %u454, 1
	store i32 %u455, i32* %i
	br label %LU153
LU155:
	%u456 = load %struct.node** %myList
	call void @freeList(%struct.node* %u456)
	%u458 = load %struct.node** %copyList1
	call void @freeList(%struct.node* %u458)
	%u460 = load %struct.node** %copyList2
	call void @freeList(%struct.node* %u460)
	store i32 0, i32* %_retval_
	br label %LU152
LU152:
	%u462 = load i32* %_retval_
	ret i32 %u462
}
