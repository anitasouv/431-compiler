...
LU27:
	...
	%u44 = load i32* %u43
	%u45 = call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.print,i32 0, i32 0), i32 %u44)
...
LU28:
	...
	%u51 = call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.print,i32 0, i32 0), i32 %u49)
	br label %LU29
LU29:
...
LU30:
	...
	%u64 = call i32 (i8*, ... )* @printf(i8* getelementptr inbounds ([5 x i8]*@.print,i32 0, i32 0), i32 %u62)
